...
function boardResize() {
    ...
    if ((winHeight - 376) * 3 >= winWidth * 5) {
        ...
        $('#mainChessBoard').height(winWidth * 0.9 / 4 * 6);
        $('.square').width(winWidth * 0.9 / 4 - 4.01);
        $('.square').height(winWidth * 0.9 / 4 - 4.01);
        $('.piece').width(winWidth * 0.9 / 4 - 4.01);
        $('.piece').height(winWidth * 0.9 / 4 - 4.01);

    } else {

        $('#mainChessBoard').width((winHeight - 376) * 0.9 / 6 * 4);
        $('#mainChessBoard').height((winHeight - 376) * 0.9);
        $('.square').width((winHeight - 376) * 0.9 / 6 - 4.01);
        $('.square').height((winHeight - 376) * 0.9 / 6 - 4.01);
        $('.piece').width((winHeight - 376) * 0.9 / 6 - 4.01);
        $('.piece').height((winHeight - 376) * 0.9 / 6 - 4.01);
