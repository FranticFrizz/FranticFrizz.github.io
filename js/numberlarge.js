var Chessboard = class Chessboard {
    ...
    addPieces(positions) { //Add pieces to board, positions of pieces as argument
        ...
        var wnum4 = "img/num4.png";
        var bnum4 = "img/hidden.png";
        var wnum5 = "img/num5.png";
        var bnum5 = "img/hidden.png";
        var wnum0 = "img/num0.png";
        var bnum0 = "img/hidden.png";
        var wnumminus1 = "img/numminus1.png";
        var bnumminus1 = "img/hidden.png";
        var wnumminus2 = "img/numminus2.png";
        var bnumminus2 = "img/hidden.png";
        ...
        var white_num4 = positions.white.num4;
        var black_num4 = positions.black.num4;
        var white_num5 = positions.white.num5;
        var black_num5 = positions.black.num5;
        ...
        var white_numminus2 = positions.white.numminus2;
        var black_numminus2 = positions.black.numminus2;
        ...
        for (var x = 0; x < this.row; x++) {
            for (var i = 0; i < this.col; i++) {
                ...
                else if (white_num4.indexOf(id) > -1) {
                    elem.setAttribute("src", wnum4);
                    elem.setAttribute("side", "white");
                    elem.setAttribute("type", "num4");
                    elem.setAttribute("prior", num4_prior);
                }
                else if (black_num4.indexOf(id) > -1) {
                    elem.setAttribute("src", bnum4);
                    elem.setAttribute("side", "black");
                    elem.setAttribute("type", "num4");
                    elem.setAttribute("prior", num4_prior);
                }
                else if (white_num5.indexOf(id) > -1) {
                    elem.setAttribute("src", wnum5);
                    elem.setAttribute("side", "white");
                    elem.setAttribute("type", "num5");
                    elem.setAttribute("prior", num5_prior);
                }
                else if (black_num5.indexOf(id) > -1) {
                    elem.setAttribute("src", bnum5);
                    elem.setAttribute("side", "black");
                    elem.setAttribute("type", "num5");
                    elem.setAttribute("prior", num5_prior);
                }
                ...
                else if (white_numminus2.indexOf(id) > -1) {
                    elem.setAttribute("src", wnumminus2);
                    elem.setAttribute("side", "white");
                    elem.setAttribute("type", "numminus2");
                    elem.setAttribute("prior", numminus2_prior);
                }
                else if (black_numminus2.indexOf(id) > -1) {
                    elem.setAttribute("src", bnumminus2);
                    elem.setAttribute("side", "black");
                    elem.setAttribute("type", "numminus2");
                    elem.setAttribute("prior", numminus2_prior);
                }
        ...
        if (self.gamestate == 'prep') {
            if (!e.target.classList.contains('piece') && Number(e.target.getAttribute('id').slice(1)) <= 2) {
                switch(self.prepPiece) {
                    ...
                    self.addPieces(pos);
                    self.prepPiece = 3;
                    self.terminalT.innerHTML = 'put num4 piece';
                    break;
                    ...
                    self.addPieces(pos);
                    self.prepPiece = 4;
                    self.terminalT.innerHTML = 'put num5 piece';
                    break;
                    ...
                    self.addPieces(pos);
                    self.prepPiece = 7;
                    self.terminalT.innerHTML = 'put numminus2 piece';
                    break;
                    ...
                    var pos = {
                        "white": {
                            ...
                            "num0": [""],
                            "numminus1": [""],
                            "numminus2": [e.target.getAttribute('id')]
                        }, "black": {
                            "num1": [""],
                            "num2": [""],
                            "num3": [""],
                    ...
                    if (self.playingVS == 'vsai') {
                        ...
                        var pos = {
                            "white": {
                                ...
                                "num1": [opTerritory[rArr[0]]],
                                "num2": [opTerritory[rArr[1]]],
                                "num3": [opTerritory[rArr[2]]],
                                "num4": [opTerritory[rArr[3]]],
                                "num5": [opTerritory[rArr[4]]],
                                "num0": [opTerritory[rArr[5]]],
                                "numminus1": [opTerritory[rArr[6]]],
                                "numminus2": [opTerritory[rArr[7]]]
                            }
                        };
                        self.addPieces(pos);
                    } else {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: JSON.stringify({nums: pos, userId: self.userId}),
                            contentType: 'application/json',
                            dataType: 'json',
                            async: false,
                            complete: function (data) {
